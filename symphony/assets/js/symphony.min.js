...
top:0,freespace:0,bottom:0,height:0,maxtop:0};/*---------------------------------------------------------------------
		...
		---------------------------------------------------------------------*/
// Init
return a.extend(e,b),d.each(function(){var b=a.extend({},e),d=a(this),f=function(){b.top=b.container.offset().top-95,b.freespace=b.container.height(),b.bottom=b.top+b.freespace,b.height=d.height(),b.maxtop=b.freespace-b.height+"px"};
...
a(window).scroll(function(e){d=a(this).scrollTop(),b.Utilities.requestAnimationFrame(function(){c.each(function(){var b=a(this),c=b.data("affix-settings"),e="js-affix-scroll",f="";console.log(c.top),d<c.top?e="js-affix-top":d>c.bottom&&(e="js-affix-bottom",f=c.maxtop),
