...
a(window).scroll(function(e){d=a(this).scrollTop(),b.Utilities.requestAnimationFrame(function(){c.each(function(){var b=a(this),c=b.data("affix-settings"),e="js-affix-scroll",f="";console.log(c.top),d<c.top?e="js-affix-top":d>c.bottom&&(e="js-affix-bottom",f=c.maxtop),b.hasClass(e)||b.removeClass("js-affix-scroll js-affix-top js-affix-bottom").addClass(e).css({top:f})})})})}(window.jQuery,window.Symphony),/**
 * @package assets
 */
function(a,b){
